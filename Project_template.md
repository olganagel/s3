...
- Связь user_house
Каждый пользователь может иметь несколько домов и каждый дом может принадлежать нескольким пользователям, всякую связь многие ко многим нужно разделять промежуточной таблицей
